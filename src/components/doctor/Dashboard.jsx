  ...
  return (
    <div className='flex flex-col p-4'>
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className='lg:w-3/4 bg-[#F7F4FF] shadow-md rounded-lg overflow-x-auto py-3 px-2'>
          ...
          {/* Table Container */}
          <div className="max-h-[400px] bg-[#F7F4FF] overflow-y-auto scrollbar-w-1 scrollbar scrollbar-thumb-[#413D80] scrollbar-track-slate-300">
            <table className="min-w-full leading-normal overflow-x-auto">
              <thead>
                <tr>
                  <th className="px-4 py-2 bg-[#BED0FF] text-[#413D80] text-left text-xs font-semibold">Visit Code</th>
                  <th className="px-4 py-2 bg-[#BED0FF] text-[#413D80] text-left text-xs font-semibold">Patient Name</th>
                  <th className="px-4 py-2 bg-[#BED0FF] text-[#413D80] text-left text-xs font-semibold">Age</th>
                  <th className="px-4 py-2 bg-[#BED0FF] text-[#413D80] text-left text-xs font-semibold">Gender</th>
                  <th className="px-4 py-2 bg-[#BED0FF] text-[#413D80] text-left text-xs font-semibold">Action</th>
                </tr>
              </thead>
              <tbody>
                {list.map((data, index) => (
                  <tr key={index}>
                    <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">{data.visitCode}</td>
                    <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">{data.patientName}</td>
                    <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">{data.age}</td>
                    <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">{data.gender}</td>
                    <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">
      ...
      <div className='my-4'>
        <span className='text-[#413D80] font-medium text-lg text-center mb-4 md:mb-2 block'>Patient List</span>
        <div className="overflow-x-auto">
          <table className="min-w-full">
            <thead>
              <tr>
                <th className="px-4 py-2 bg-[#F3F7FF] text-[#413D80] text-left text-sm font-semibold">Patient Name</th>
                <th className="px-4 py-2 bg-[#F3F7FF] text-[#413D80] text-left text-sm font-semibold">Patient ID</th>
                <th className="px-4 py-2 bg-[#F3F7FF] text-[#413D80] text-left text-sm font-semibold">Weight</th>
                <th className="px-4 py-2 bg-[#F3F7FF] text-[#413D80] text-left text-sm font-semibold">Blood Pressure</th>
                <th className="px-4 py-2 bg-[#F3F7FF] text-[#413D80] text-left text-sm font-semibold">Action</th>
              </tr>
            </thead>
            <tbody>
              {list.map((data, index) => (
                <tr key={index}>
                  <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">{data.patientName}</td>
                  <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">{data.visitCode}</td>
                  <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">{data.age} kg</td>
                  <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">120/80</td>
                  <td className="px-4 py-2 text-[#616161] text-sm border-b-2 border-gray-200">
                    <button onClick={() => handleIndividualPatient(data.visitCode)} className="bg-[#DBFFDE] p-2 rounded-lg">
                      <img src={eye} alt="View" className="w-4 h-4" />
                    </button>
