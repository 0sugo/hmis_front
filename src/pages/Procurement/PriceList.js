  ...
  return (
    <div className='mx-auto p-4'>
      <div className='flex items-center justify-between'>
        ...
        <Link to='/app/addnewpricelist' className='bg-[#0E6F1E] text-[#DBFFDE] hover:bg-[#35a147] px-5 py-2 rounded-lg'>Add New Price List</Link>
      </div>
      ...
      <section className='bg-white p-4 my-4 rounded-lg'>
        <div className='overflow-x-auto rounded-lg'>
          <table className='w-full table-auto'>
            <thead>
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold">PriceList ID</th>
                <th className="px-6 py-3 text-left text-xs font-semibold">PriceList Name</th>
              ...
              {list.map((data, index) => (
                <tr key={index}>
                  ...
                  <td className='py-2 px-6 flex items-center space-x-2'>
                    <Link to={`/app/viewpricelist/${data.No}`}>
