          ...
          <div className="bg-white p-4 rounded-lg">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              <div className="md:col-span-2 flex flex-col items-center gap-4">
                ...
                <span className="text-[#192252]">{patient.patient_firstname ? `${patient.patient_firstname} ${patient.patient_lastname}` : "No name available"}</span>
              </div>
              <div className="md:col-span-5 text-[#413D80] text-sm">
                <p className="grid grid-cols-3"><span>Patient Name:</span><span className="text-[#616161] col-span-2">{patient.patient_firstname ? `${patient.patient_firstname} ${patient.patient_lastname}` : "No name available"}</span></p>
                <p className="grid grid-cols-3"><span>Age:</span><span className="text-[#616161] col-span-2">{patient.dob ? ageCalculator(patient.dob) : "Age not available"}</span></p>
                <p className="grid grid-cols-3"><span>Gender:</span><span className="text-[#616161] col-span-2">{patient.gender || "No gender available"}</span></p>
                <p className="grid grid-cols-3"><span>Occupation:</span><span className="text-[#616161] col-span-2">{patient.occupation || "No occupation available"}</span></p>
                <p className="grid grid-cols-3"><span>Scheme company:</span><span className="text-[#616161] col-span-2">Britam</span></p>
              </div>
              <div className="md:col-span-5 text-[#413D80] text-sm">
                <p className="grid grid-cols-3"><span>Visit Code:</span><span className="text-[#616161] col-span-2">{patient.patient_code || "No visit code available"}</span></p>
                <p className="grid grid-cols-3"><span>Scheme-type:</span><span className="text-[#616161] col-span-2">Kilifi Country Government</span></p>
                <p className="grid grid-cols-3"><span>Prescription No:</span><span className="text-[#616161] col-span-2">MHP1-000001</span></p>
                <p className="grid grid-cols-3"><span>Address:</span><span className="text-[#616161] col-span-2">{patient.address || "No Address available"}</span></p>
