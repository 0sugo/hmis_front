  ...
  return (
    <div className='mx-auto p-4'>
      <div className='flex items-center justify-between'>
        <h4 className='font-semibold my-4'>Imaging <span className='text-[#0E6F1E]'>> Patient</span></h4>
        <Link to='/app/imagingform' className='bg-[#0E6F1E] text-[#DBFFDE] hover:bg-[#35a147] px-5 py-2 rounded-lg'>Form</Link>
      </div>
              ...
              {list.map((data, index) => (
                <tr key={index}>
                  ...
                  <td className='py-2 px-6 flex items-center space-x-2'>
                    <Link to={`/app/viewimagingpatient/${data.No}`}>
