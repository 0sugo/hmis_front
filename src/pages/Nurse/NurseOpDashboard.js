        ...
        <div className="flex flex-wrap items-center gap-2 justify-between my-4">
          <div>
            ...
            <div className="flex gap-2">
              <Link to='/app/' className='bg-[#E7F1E9] text-[#0E6F1E] px-5 py-2 rounded-lg font-semibold'>Add Service</Link>
              <Link to='/app/' className='bg-[#E7F1E9] text-[#0E6F1E] px-5 py-2 rounded-lg font-semibold'>Report Incident</Link>
            </div>
          </div>
          <div>
            ...
            <table className='w-full table-auto'>
              <thead>
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-semibold">Triage</th>
                  <th className="px-6 py-3 text-left text-xs font-semibold">Wait Time</th>
